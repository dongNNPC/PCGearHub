 ...
 */
	...
	$scope.pageCount;
	$scope.category = {};
	$scope.category.image; // Khởi tạo trường image của category
	$scope.items = [];
	...
	/*edit*/
	// Hàm edit dùng để tải thông tin danh mục có id tương ứng và gán vào biến $scope.category
	$scope.edit = function () {
	...
	// Hàm validation dùng để kiểm tra trường ID của category có trùng lặp hay không
